<h2><a href="https://www.geeksforgeeks.org/problems/greatest-of-three--154612/1&selectedLang=python3">Greatest of three numbers</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given three numbers a, b and c. Find the greatest number among them.</span></p>
